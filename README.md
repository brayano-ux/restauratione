...
<body id="bod" data-aos="fade-down-right">
    ...
    <div id="ladiv">
            ...
            <div class="container-fluid px-2 py-2">
                <div class="row align-items-center justify-content-between entete-content flex-wrap">
                    ...
                    <div
                        ...
                        <button class="btn btn-primary me-2 mb-1 mb-md-0" id="vendre">💼 Vendre</button>
                        <button class="btn btn-success me-2 mb-1 mb-md-0" id="connexionn">🔐 Connexion</button>
        ...
        <div id="connexion" style="display: none;">
            ...
            <div id="formConnexion">
                ...
                <button id="afficherInscription" class="btn btn-secondary" type="button">Créer un Compte</button>
            </div>
            <div id="formInscription" style="display:none;">
                <input type="text" class="nom" id="nomIns" placeholder="👤 Entrez votre nom" />
                <input type="number" class="nom" id="numeroIns" placeholder="📱 Votre numéro" />
                <input type="email" class="nom" id="emailIns" placeholder="📧 Entrez votre adresse email" />
                <input type="password" class="nom" id="motdepasseIns" placeholder="🔒 Mot de passe" />
                <button id="btnCreerCompte">✨ Créer un Compte</button>
                <button id="afficherConnexion" class="btn btn-secondary" type="button">Déjà inscrit ? Se
                    connecter</button>
            </div>
        </div>
    ...
    <script>
        // Gestion du paiement après 3 actions sur vendre/acheter
        ...
        function showPaiementMessage() {
            alert('Il faut payer 200 FCFA pour continuer.');
        }
        ...
        function handleActionClick(e) {
            if (!paiementEffectue) {
                ...
                // Après paiement, chaque action affiche le message
                showPaiementMessage();
            }
            return true;
        }
        ...
        if (btnPayer) {
            btnPayer.addEventListener('click', function () {
                ...
                actionsRestantes = 9999; // ou une grande valeur
                localStorage.setItem('actionsRestantes', actionsRestantes);
                updateBoutonsEtat();
                alert('Paiement réussi ! Vous pouvez continuer à vendre ou acheter.');
            });
        }
        updateBoutonsEtat();
    </script>
    <script type="module">
        ...
        async function lireConversations() {
            ...
            // On ne remplace pas tout le innerHTML, on ajoute le header puis les conversations
        ...
        btnCreerCompte.addEventListener("click", async () => {
            try {
                ...
                if (!nom || nom.length < 2) {
                    Swal.fire("Le nom doit contenir au moins 2 caractères");
                    return;
                }
        ...
        function validateInput(input, type) {
            ...
            switch (type) {
                ...
                case 'price':
                    ...
                    if (parseFloat(value) > 1000000) return 'Prix trop élevé';
                    break;
            }
